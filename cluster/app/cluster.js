...
cluster = require('cluster')
  , zmq = require('zeromq')
  , backAddr = process.env.ZMQ_CLUSTER_BACK_ADDRESS || 'tcp://127.0.0.1:12345'
  , frontAddr = process.env.ZMQ_CLUSTER_FRONT_ADDRESS || 'tcp://127.0.0.1:12346'
  , clients = process.env.ZMQ_CLUSTER_CLIENTS || 10
  , workers = process.env.ZMQ_CLUSTER_WORKERS || 3;
